...
public class SpringDockerCodegen extends AbstractJavaCodegen
    ...
    private Logger logger = LoggerFactory.getLogger(AbstractJavaCodegen.class);
    ...
    public void processOpts() {
        ...
        if (additionalProperties.containsKey(CodegenConstants.INVOKER_PACKAGE)) {
            ...
            additionalProperties.put(BASE_PACKAGE, basePackage);
            this.logger.info("Set base package to invoker package (" + basePackage + ")");
        }
        ...
        supportingFiles.add(new SupportingFile("build.mustache","","buildDocker.sh"));
        supportingFiles.add(new SupportingFile("start.mustache","","startDocker.sh"));
        supportingFiles.add(new SupportingFile("mavendocker-entrypoint.mustache","","build.sh"));
    ...
    public void addImportMapping(String key, String value){
        this.importMapping.put(key,value);
    }

    public void addImportMappings(Map<String,String> imports){
        this.importMapping.putAll(imports);
    }
